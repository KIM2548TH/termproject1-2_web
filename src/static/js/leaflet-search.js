...
(function (factory) {
  ...
  L.Control.Search = L.Control.extend({
    ...
    onAdd: function (map) {
      ...
      this._container.style.backgroundColor = '#333333'; // Dark background
      this._container.style.color = '#f5f5f5'; // Light text color
      this._container.style.padding = '10px';
      this._container.style.borderRadius = '8px';
      this._container.style.boxShadow = '0px 0px 10px rgba(0,0,0,0.2)';

      this._input = this._createInput(this.options.textPlaceholder, 'search-input');
      this._input.style.display = 'block'; // Ensure input is visible
      this._input.style.backgroundColor = '#444444'; // Dark input background
      this._input.style.color = '#f5f5f5'; // Light input text color
